...
function displayWeatherData(data) {
    ...
    document.querySelector('#temperatureMin').textContent = `Min Temperature: ${data.forecast.forecastday[0].day[0].mintemp_c}°C/${data.forecast.forecastday[0].day.mintemp_f}°F`;
