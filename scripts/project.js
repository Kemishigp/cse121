...
function displayWeatherData(data) {
    ...
    // FORECAST DATA
    document.querySelector('#temperatureMax').textContent = `Max Temperature: ${data.forecast.forecastday[2].day.maxtemp_c}°C/${data.forecast.forecastday[2].day.maxtemp_f}°F`;
